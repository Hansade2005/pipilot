...
// Exercises: Kokoro TTS (top-level am_fenrir voice + a per-scene af_heart override),
// title/still cards, Ken Burns stills, Jamendo music, captions, and the ffmpeg path.
const storyboard = {
  title: 'PiPilot Video',
  aspect: '16:9',
  ...
  captions: true,
  scenes: [
    { kind: 'title', dur: 3.5, title: 'PiPilot Video', sub: 'generated from a script', say: 'This narration is generated by Kokoro, not Piper.' },
    { kind: 'still', dur: 3.4, topic: 'Technology', forward: true, say: 'The male voice here is am fenrir, bold and clear.' },
    { kind: 'still', dur: 3.4, keyword: 'city skyline', forward: false, voice: 'af_heart', say: 'And this line switches to a female Kokoro voice mid-video.' },
    { kind: 'still', dur: 3.4, topic: 'Nature', forward: true, say: 'Consistent, natural narration across every scene.' },
    { kind: 'credits', dur: 3 },
  ],
}
